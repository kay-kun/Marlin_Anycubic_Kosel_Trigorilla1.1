...
#define STRING_CONFIG_H_AUTHOR "(KayKun)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AnyCubic Kossel TriGorilla 1.1 Marlin 2.x BugFIX"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki_LIST {   1.63 }
    #define DEFAULT_Kd_LIST { 76.48 }
  #else
...
#define DELTA
  ...
  #define DELTA_HEIGHT 327.00             // (mm) Get this value from G33 auto calibrate
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 50     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
